 ...
 * </p>
 * 
 * <p product="flash">This class is included in the ServiceMonitorShim.swc file. 
 * To use classes in the air.net package in Adobe<sup>&#xAE;</sup> 
 * Flash<sup>&#xAE;</sup>, you must first drag the ServiceMonitorShim 
 * component from the Components panel to the Library and then add the following 
 * <code>import</code> statement to your ActionScript 3.0 code:
 * </p>
 * 
