...
/**
 * {@link org.springframework.beans.factory.config.BeanFactoryPostProcessor} that will automatically configure Hibernate AMF serialization support if:
 * <ol>
...
public class HibernateSerializationConfigPostProcessor implements BeanFactoryPostProcessor {
    ...
    private static final String HIBERNATE_CONFIG_PROCESSOR_CLASS = "org.springframework.flex.orm.hibernate4.HibernateConfigProcessor";
