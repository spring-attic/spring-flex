...
public class FlexConfigurationManagerTests extends AbstractRuntimeEnvironmentAwareTests {
    ...
    public void testCustomConfiguration() {
        ...
        configManagerDef.getPropertyValues().addPropertyValue("configurationPath", "classpath:org/springframework/flex/hibernate4/core/services-config.xml");
    ...
    public void testGetMessagingConfiguration() {
        this.configManager = new FlexConfigurationManager(this.context, "classpath:org/springframework/flex/hibernate4/core/services-config.xml");
    ...
    public void testGetMessagingConfigurationDoesNotExist() {
        this.configManager = new FlexConfigurationManager(this.context, "classpath:org/springframework/flex/hibernate4/core/foo.xml");
    ...
    public void testGetMessagingConfiguration_ClasspathResourcePatternTooAmbiguous() {
        this.configManager = new FlexConfigurationManager(this.context, "classpath*:org/springframework/flex/hibernate4/core/*-config.xml");
    ...
    public void testGetMessagingConfiguration_IncludedChannelsFiles() {
        this.configManager = new FlexConfigurationManager(this.context, "classpath:org/springframework/flex/hibernate4/core/services-config-4.6.xml");
