...
@ContextConfiguration(locations="classpath:org/springframework/flex/hibernate4/config/jpa-message-broker.xml", inheritLocations=false, loader=JpaMultiEntityManagerConfigurationTests.ParentContextLoader.class)
public class JpaMultiEntityManagerConfigurationTests extends AbstractFlexConfigurationTests {
    ...
    public static final class ParentContextLoader extends MessageBrokerContextLoader {
        ...
        protected ConfigurableApplicationContext createParentContext() {
            ...
            new XmlBeanDefinitionReader(context).loadBeanDefinitions(new String[] { "classpath:org/springframework/flex/hibernate4/core/io/jpa-multi-entity-manager-context.xml" });
