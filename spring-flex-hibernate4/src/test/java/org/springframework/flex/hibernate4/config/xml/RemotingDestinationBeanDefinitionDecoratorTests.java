...
import org.springframework.flex.hibernate4.config.xml.RemotingDestinationBeanDefinitionParserTests.TestAdapter;
...
@ContextConfiguration("classpath:org/springframework/flex/hibernate4/config/remote-service-decorator.xml")
public class RemotingDestinationBeanDefinitionDecoratorTests extends AbstractFlexConfigurationTests {
    ...
    public void testInvalidConfig() {
        try {
            new ClassPathXmlApplicationContext("org/springframework/flex/hibernate4/config/invalid-remote-service-decorator.xml");
