...
package org.springframework.flex.hibernate4.core;
...
import org.springframework.flex.hibernate4.config.AbstractRuntimeEnvironmentAwareTests;
...
public abstract class AbstractMessageBrokerTests extends AbstractRuntimeEnvironmentAwareTests {
	...
	protected String getServicesConfigPath() {
		return "classpath:org/springframework/flex/hibernate4/core/services-config.xml";
	}
