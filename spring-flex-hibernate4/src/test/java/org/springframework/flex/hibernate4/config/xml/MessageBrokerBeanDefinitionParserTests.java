...
@ContextConfiguration(locations="classpath:org/springframework/flex/hibernate4/config/message-broker.xml", loader=MessageBrokerBeanDefinitionParserTests.ParentContextLoader.class)
public class MessageBrokerBeanDefinitionParserTests extends AbstractFlexConfigurationTests {
    ...
    public void testMessageBroker_DefaultSecured_DataServices() {
        ...
        try {
            ...
            // Should contain org.springframework.flex.hibernate4.security3.PerClientAuthenticationInterceptor and,
            // org.springframework.flex.hibernate4.security3.LoginMessageInterceptor
            assertEquals(2, interceptors.size());

            // Should contain org.springframework.flex.hibernate4.security3.SecurityExceptionTranslator
    ...
    public void testMessageBroker_InvalidConfig() {
        try {
            new ClassPathXmlApplicationContext("org/springframework/flex/hibernate4/config/invalid-message-broker.xml");
    ...
    public static final class ParentContextLoader extends MessageBrokerContextLoader {
        ...
        protected ConfigurableApplicationContext createParentContext() {
            ...
            new XmlBeanDefinitionReader(context).loadBeanDefinitions(new String[] { "classpath:org/springframework/flex/hibernate4/config/security-context.xml", "classpath:org/springframework/flex/hibernate4/core/io/hibernate-jpa-context.xml" });
