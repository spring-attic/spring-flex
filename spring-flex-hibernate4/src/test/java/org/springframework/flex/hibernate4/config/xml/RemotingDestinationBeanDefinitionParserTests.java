...
@ContextConfiguration("classpath:org/springframework/flex/hibernate4/config/remote-service.xml")
public class RemotingDestinationBeanDefinitionParserTests extends AbstractFlexConfigurationTests {
    ...
    public void testInvalidConfig() {
        try {
            new ClassPathXmlApplicationContext("org/springframework/flex/hibernate4/config/invalid-remote-service.xml");
