...
import org.springframework.flex.orm.hibernate3.io.HibernateProxyConverter;
...
public class HibernateConfigProcessor extends AbstractAmfConversionServiceConfigProcessor implements BeanFactoryAware, InitializingBean {
	 ...
	 * used in determining the types that need a {@link org.springframework.flex.core.io.SpringPropertyProxy}
	 * registered in {@link #findTypesToRegister()}
	 * @param sessionFactory the session factory from which to read metadata
	 */
