...
public class HibernateSerializationConfigPostProcessor implements BeanFactoryPostProcessor {
    ...
    private static final String HIBERNATE_CONFIG_PROCESSOR_CLASS = "org.springframework.flex.hibernate3.config.HibernateConfigProcessor";
    
    private static final String JPA_HIBERNATE_CONFIG_PROCESSOR_CLASS = "org.springframework.flex.hibernate3.config.JpaHibernateConfigProcessor";
