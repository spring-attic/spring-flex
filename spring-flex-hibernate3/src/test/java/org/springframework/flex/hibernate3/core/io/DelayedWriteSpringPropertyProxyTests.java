...
import org.springframework.flex.hibernate3.core.io.domain.ImmutableValueObject;
...
public class DelayedWriteSpringPropertyProxyTests {
    ...
    public void setUp() {
        ...
        SpringPropertyProxy personProxy = SpringPropertyProxy.proxyFor(Person.class, false, cs);
    ...
    public void deserializeAnnotatedImmutableObject() throws IOException, ClassNotFoundException {
        ...
        Assert.assertNotNull(result.getPersonRef());
