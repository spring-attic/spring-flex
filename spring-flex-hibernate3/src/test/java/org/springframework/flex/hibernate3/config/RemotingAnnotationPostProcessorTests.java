...
@ContextConfiguration(locations="classpath:org/springframework/flex/hibernate3/config/remote-service-annotations.xml", loader=RemotingAnnotationPostProcessorTests.ParentContextLoader.class)
public class RemotingAnnotationPostProcessorTests extends AbstractFlexConfigurationTests {
    ...
    public static class ParentContextLoader extends MessageBrokerContextLoader {
        ...
        protected ConfigurableApplicationContext createParentContext() {
            ...
            new XmlBeanDefinitionReader(context).loadBeanDefinitions(new String[] { "classpath:org/springframework/flex/hibernate3/config/annotated-remote-bean-context.xml" });
            context.refresh();
            return context;
        }
    }
