...
import org.springframework.core.convert.PropertyTypeDescriptor;
 ...
 *
 * <p>{@code BeanWrapperAccessor} will convert collection and array values
 ...
 */
public class BeanWrapperAccessor extends AbstractPropertyAccessor implements BeanWrapper {

	/**
	 * We'll create a lot of these objects, so we don't want a new logger every time.
	 */
	private static final Log logger = LogFactory.getLog(BeanWrapperAccessor.class);
	 ...
	 */
	private Map<String, BeanWrapperAccessor> nestedBeanWrappers;
	...
	/**
	 * Create new empty BeanWrapperAccessor. Wrapped instance needs to be set afterwards.
	 * Registers default editors.
	 * @see #setWrappedInstance
	 */
	public BeanWrapperAccessor() {
		this(true);
	}
	 ...
	 * @see #setWrappedInstance
	 */
	public BeanWrapperAccessor(boolean registerDefaultEditors) {
	...
	/**
	 * Create new BeanWrapperAccessor for the given object.
	 * @param object object wrapped by this BeanWrapper
	 */
	public BeanWrapperAccessor(Object object) {
		registerDefaultEditors();
		setWrappedInstance(object);
	}

	/**
	 * Create new BeanWrapperAccessor, wrapping a new instance of the specified class.
	 * @param clazz class to instantiate and wrap
	 */
	public BeanWrapperAccessor(Class<?> clazz) {
		registerDefaultEditors();
	 ...
	 */
	public BeanWrapperAccessor(Object object, String nestedPath, Object rootObject) {
		registerDefaultEditors();
	 ...
	 */
	private BeanWrapperAccessor(Object object, String nestedPath, BeanWrapperAccessor superBw) {
	...
	protected PropertyDescriptor getPropertyDescriptorInternal(String propertyName) throws BeansException {
		...
		BeanWrapperAccessor nestedBw = getBeanWrapperForPropertyPath(propertyName);
		...
		try {
			...
			if (pd != null) {
				if (tokens.keys != null) {
					...
					if (pd.getReadMethod() != null || pd.getWriteMethod() != null) {
						return new PropertyTypeDescriptor(property(pd));
					}
				}
			}
		}
	...
	private Object convertForProperty(String propertyName, Object oldValue, Object newValue, PropertyDescriptor pd)
		...
		return convertIfNecessary(propertyName, oldValue, newValue, pd.getPropertyType(), new PropertyTypeDescriptor(property(pd)));
	}
	 ...
	 */
	protected BeanWrapperAccessor getBeanWrapperForPropertyPath(String propertyPath) {
		int pos = PropertyAccessorUtils.getFirstNestedPropertySeparatorIndex(propertyPath);
		// Handle nested properties recursively.
		if (pos > -1) {
			String nestedProperty = propertyPath.substring(0, pos);
			String nestedPath = propertyPath.substring(pos + 1);
			BeanWrapperAccessor nestedBw = getNestedBeanWrapper(nestedProperty);
	 ...
	 */
	private BeanWrapperAccessor getNestedBeanWrapper(String nestedProperty) {
		if (this.nestedBeanWrappers == null) {
			this.nestedBeanWrappers = new HashMap<String, BeanWrapperAccessor>();
		}
		...
		BeanWrapperAccessor nestedBw = this.nestedBeanWrappers.get(canonicalName);
	 ...
	 * <p>Default implementation creates a BeanWrapperAccessor instance.
	 * Can be overridden in subclasses to create a BeanWrapperAccessor subclass.
	 * @param object object wrapped by this BeanWrapper
	 * @param nestedPath the nested path of the object
	 * @return the nested BeanWrapper instance
	 */
	protected BeanWrapperAccessor newNestedBeanWrapper(Object object, String nestedPath) {
		return new BeanWrapperAccessor(object, nestedPath, this);
	}
